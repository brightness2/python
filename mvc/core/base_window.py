...
class AvatarWidget(NavigationWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.avatar = QImage('core/resource/shoko.png').scaled(
...
class Window(FramelessWindow):
    ...
    def __init__(self):
        ...
        self.homeInterface = HomeController(self)
        self.homeInterface.run()
    ...
    def initWindow(self):
        ...
        self.setWindowIcon(QIcon('core/resource/logo.png'))
    ...
    def setQss(self):
        ...
        with open(f'core/resource/{color}/demo.qss', encoding='utf-8') as f:
